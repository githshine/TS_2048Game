            ...
            if (arr[j].innerHTML !== '') {
                ...
                while (k < i + 1 &&
                    (parseInt(arr[k + 1].innerHTML) === parseInt(arr[k].innerHTML) ||
                        arr[k + 1].innerHTML === '')) {
                    //alert("i="+i+" j="+j+" k="+k);
                    if (parseInt(arr[k + 1].innerHTML) === parseInt(arr[k].innerHTML) &&
                        access === false) {
                    ...
                    else if (parseInt(arr[k + 1].innerHTML) === parseInt(arr[k].innerHTML) &&
                        access === true) {
            ...
            if (arr[j].innerHTML !== '') {
                ...
                while (k < 12 &&
                    (parseInt(arr[k + 4].innerHTML) === parseInt(arr[k].innerHTML) ||
                        arr[k + 4].innerHTML === '')) {
                    //alert("i="+i+" j="+j+" k="+k);
                    if (parseInt(arr[k + 4].innerHTML) === parseInt(arr[k].innerHTML) &&
                        access === false) {
                        // @ts-expect-error TS(2322): Type 'number' is not assignable to type 'string'.
                        arr[k + 4].innerHTML =
                            parseInt(arr[k + 4].innerHTML) + parseInt(arr[k].innerHTML);
                    ...
                    else if (parseInt(arr[k + 4].innerHTML) === parseInt(arr[k].innerHTML) &&
                        access === true) {
                        // @ts-expect-error TS(2367): This condition will always return 'false' since th... Remove this comment to see the full error message
                        access === false;
                    }
    ...
    for (var i = 0; i < 16; i++) {
        switch (i) {
            ...
            case 1:
                ...
                break;
            case 2:
                if (arr[2].innerHTML === arr[1].innerHTML ||
                ...
                break;
            case 3:
                if (arr[3].innerHTML === arr[2].innerHTML ||
                    arr[3].innerHTML === arr[7].innerHTML) {
                    x = true;
                }
                break;
            case 4:
                if (arr[4].innerHTML === arr[0].innerHTML ||
                ...
                break;
            case 5:
                if (arr[5].innerHTML === arr[1].innerHTML ||
                ...
                break;
            case 6:
                if (arr[6].innerHTML === arr[5].innerHTML ||
                ...
                break;
            case 7:
                if (arr[7].innerHTML === arr[3].innerHTML ||
                ...
                break;
            case 8:
                if (arr[8].innerHTML === arr[4].innerHTML ||
                ...
                break;
            case 9:
                if (arr[9].innerHTML === arr[8].innerHTML ||
                ...
                break;
            case 10:
                if (arr[10].innerHTML === arr[9].innerHTML ||
                ...
                break;
            case 11:
                if (arr[11].innerHTML === arr[7].innerHTML ||
                ...
                break;
            case 12:
                if (arr[12].innerHTML === arr[8].innerHTML ||
                    arr[12].innerHTML === arr[13].innerHTML) {
                    x = true;
                }
                break;
            case 13:
                if (arr[13].innerHTML === arr[12].innerHTML ||
                ...
                break;
            case 14:
                if (arr[14].innerHTML === arr[13].innerHTML ||
                ...
                break;
            case 15:
                if (arr[15].innerHTML === arr[11].innerHTML ||
